...
## Where we are
Building. Reference (onorca.dev) digested, plan written. Now rewriting docs/index.html.

## Arcs of this goal
- 01-redesign → [active] → rewrite hero/order of docs/{index.html,style.css,app.js}
